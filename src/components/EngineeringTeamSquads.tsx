          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            <div className="lg:col-span-8 space-y-4">
              ...
              <p className="text-slate-700 text-xs sm:text-sm font-normal leading-relaxed max-w-3xl">
                Beyond our key 52 lead architects and directors listed above, Brosdev operates a high-capacity engineering force of over <strong>200+ full-time software specialists</strong> across 15+ countries worldwide (USA, UK, Germany, France, Canada, India, and beyond).
              </p>
