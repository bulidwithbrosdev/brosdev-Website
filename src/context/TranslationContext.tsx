...
const translations: Record<LocaleCode, TranslationDictionary> = {
  en: {
    ...
    methodology: {
      ...
      subheading: "An agile software development workflow optimized for rapid speed, bank-grade code quality, and measurable business growth.",
    },
    reviews: {
      tag: "// CLIENT REVIEWS",
  ...
  us: {
    ...
    methodology: {
      tag: "// OUR METHODOLOGY",
      headline: "Transparent Engineering Pipeline",
      subheading: "An agile software development workflow optimized for rapid speed and bank-grade code quality.",
    },
    reviews: {
      tag: "// CLIENT REVIEWS",
