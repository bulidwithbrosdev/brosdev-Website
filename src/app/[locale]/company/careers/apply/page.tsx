...
function ApplyFormContent({ locale }: { locale: string }) {
  ...
  return (
    <>
      ...
      <h1 className="text-4xl sm:text-6xl font-black text-slate-900 tracking-tight leading-none uppercase mb-4">
        JOB APPLICATION
      </h1>
      ...
      {submitted ? (
        <div className="p-10 border-2 border-slate-900 bg-[#FAF8F5] text-center space-y-6 shadow-2xl">
          ...
          <h2 className="font-condensed text-3xl font-black uppercase tracking-tight text-slate-900">
...
export default function LocaleJobApplyPage({ params }: { params: Promise<{ locale: string }> }) {
